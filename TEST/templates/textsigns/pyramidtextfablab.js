var ExamplesLinks=[
  'http://3ddoctors.net/templates/textsigns/pyramidtext.html?BaseE=50&Angle=60&Thickness=1.5&HoleE=5&LineC=120&Equal=false&BottomMargin=2&SideMargin=2&Fitalic=0&Fnarrowing=100&TextThickness=2&mirror=false&textField=A|BC|DEF&textB=B&textC=C&textD=D&SelectFont=ariblk.ttf&SelectLang=Latin'
  ,
  'http://3ddoctors.net/templates/textsigns/pyramidtext.html?BaseE=50&Angle=75&Thickness=3&HoleE=20&LineC=120&Equal=true&BottomMargin=2&SideMargin=2&Fitalic=0&Fnarrowing=100&TextThickness=-1&mirror=false&textField=PI|=|3.14&textB=1592&textC=6535&textD=8979&SelectFont=ariblk.ttf&SelectLang=Latin'
  ,
  'http://3ddoctors.net/templates/textsigns/pyramidtext.html?BaseE=50&Angle=60&Thickness=1.5&HoleE=5&LineC=120&Equal=false&BottomMargin=2&SideMargin=2&Fitalic=0&Fnarrowing=100&TextThickness=2&mirror=false&textField=+|31|6873|6633&textB=10|Kerk%20st.&textC=NL|12345&textD=A.|DAM|&SelectFont=ariblk.ttf&SelectLang=Latin'
  ,
  'http://3ddoctors.net/templates/textsigns/pyramidtext.html?BaseE=50&Angle=45&Thickness=1.5&HoleE=0&LineC=120&Equal=false&BottomMargin=2&SideMargin=2&Fitalic=0&Fnarrowing=100&TextThickness=2&mirror=false&textField=A&textB=B&textC=C&textD=D&SelectFont=ariblk.ttf&SelectLang=Latin'
  ]
...
{  
  ...
  var FontSize 		=20; 
  var TextThickness 	= 1; // Number(document.getElementById('TextThickness').value);
  ...
  var BaseE 	=50; // Number(document.getElementById('BaseE').value);
  var AngleDeg 	=60; //Number(document.getElementById('Angle').value);
  var Angle 	=AngleDeg*3.14159265359/180;
  
  var Thickness 	=1.2; // Number(document.getElementById('Thickness').value);
  var ThickH		=Thickness/Math.sin(Angle);
  var HoleE 	= 35; // Number(document.getElementById('HoleE').value);
